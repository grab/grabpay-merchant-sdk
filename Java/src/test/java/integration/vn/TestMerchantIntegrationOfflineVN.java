...
public class TestMerchantIntegrationOfflineVN {
    ...
    public static void setUp() {
        ...
        final String partner_id = System.getenv("VN_STG_POS_PARTNER_ID");
        final String partner_secret = System.getenv("VN_STG_POS_PARTNER_SECRET");
        final String merchant_id = System.getenv("VN_STG_POS_MERCHANT_ID");
        final String terminal_id = System.getenv("VN_STG_POS_TERMINAL_ID");
