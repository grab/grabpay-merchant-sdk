 ...
 * 
 */
public class PromoRefundDetails {
    ...
    public String toString() {
        ...
        sb.append(PromoRefundDetails.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PromoRefundDetails) == false) {
            return false;
        }
        PromoRefundDetails rhs = ((PromoRefundDetails) other);
